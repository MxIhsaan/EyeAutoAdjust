...
public class Eye_Adjust_Other extends PlugInFrame implements ImageListener, Runnable 
    {
    ...
    /* Initialization */
    public Eye_Adjust_Other() 
    {
        super("Eye_Adjust_Other");
        ...
        bgThread = new Thread(this, "Eye_Adjust_Other");         // creates the thread
        bgThread.start();
    ...
    {
        iX = (int) (((x - cX)/avgScale));
        iY = (int) (((y - cY)/avgScale));
