...
public class Eye_Adjust_Mouse extends PlugInFrame implements ImageListener, Runnable 
    {
    ...
    /* Initialization */
    public Eye_Adjust_Mouse() 
    {
        super("Eye_Adjust_Mouse");
        ...
        bgThread = new Thread(this, "Eye_Adjust_Mouse");         // creates the thread
        bgThread.start();
    ...
    // {
    //     iX = (int) (((x - cX)/avgScale));       // 0.808... = scale factor to get correct eye tracker coords
    //     iY = (int) (((y - cY)/avgScale));       // matlab code doesnt give correct value. it is offset to the side
    ...
    {
        rX = jX - rWidth/2;         // coordinates where the roi starts from (center of roi is eye coords)
        rY = jY - rHeight/2;
